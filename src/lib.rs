...
//! RFC 6716 + RFC 8251 + RFC 7587 in a future clean-room round, using
//! only material under `docs/` and black-box validator binaries.
//!
...
impl core::fmt::Display for Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        write!(
            f,
            "oxideav-opus: orphan-rebuild scaffold — no decoder/encoder wired up"
        )
    }
}
